 ...
 * @since 04.09.2020
 */
public class BooleanFieldValue extends JsonFieldValue<Boolean> {

    public static final String CODE = "bool";

    public BooleanFieldValue() { super(CODE); }

    public BooleanFieldValue(Boolean value) { super(CODE, value); }

    public BooleanFieldValue(Boolean value, String title) {
