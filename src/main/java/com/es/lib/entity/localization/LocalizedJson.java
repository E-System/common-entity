...
public class LocalizedJson extends HashMap<String, HashMap<String, String>> {
    ...
    public LocalizedJson(int initialCapacity, float loadFactor) {
        super(initialCapacity, loadFactor);
    }

    public LocalizedJson(Map<? extends String, ? extends HashMap<String, String>> m) {
        super(m);
    }

    public LocalizedJson(Collection<String> fields) {
        this(fields, null);
    }

    public LocalizedJson(Collection<String> fields, Collection<String> locales) {
